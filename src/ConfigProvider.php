...
class ConfigProvider
{
    ...
    public function getDependencies() : array
    {
        return [
            'aliases' => [
                LinkGenerator\UrlGeneratorInterface::class => LinkGenerator\MezzioUrlGenerator::class,

                // Legacy Zend Framework aliases
                \Zend\Expressive\Hal\LinkGenerator\UrlGeneratorInterface::class => LinkGenerator\UrlGeneratorInterface::class,
