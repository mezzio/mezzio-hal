...
The `ResourceGenerator` allows composing `Mezzio\Hal\ResourceGenerator\Strategy`
...
`Mezzio\Hal\ResourceGenerator\ExtractCollection` and
`Mezzio\Hal\ResourceGenerator\ExtractInstance`; inspect these if you
